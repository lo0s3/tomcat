...
parser.add_argument('-c', dest='creds', required=True, metavar="FILE")
parser.add_argument('-i', dest='hosts', required=True, metavar="FILE")
parser.add_argument('-t', dest="threads", required=True, type=int, default=16)
